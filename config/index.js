...
const CONFIG = {
  ...
  SQLITE: {
    DB_PATH: process.env.SQLITE_DB_PATH || './data/timetracker.db',
    ENABLED: process.env.USE_SQLITE !== 'false' // default เปิดใช้งาน
  },
  // 🆕 Sync Configuration
  SYNC: {
    INTERVAL_MS: parseInt(process.env.SYNC_INTERVAL_MS) || 5 * 60 * 1000, // default 5 นาที
    ENABLED: process.env.SYNC_ENABLED !== 'false', // default เปิดใช้งาน
    SYNC_ON_STARTUP: process.env.SYNC_ON_STARTUP !== 'false' // default โหลดจาก Sheets ตอน startup
  },
